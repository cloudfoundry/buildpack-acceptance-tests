...
var _ = Describe("appdynamics", func() {
	...
	BeforeEach(func() {
		...
		serviceBrokerApp = cutlass.New(filepath.Join(testdata, "fake_appd_service_broker"))
		...
		app = cutlass.New(filepath.Join(testdata, "with_appdynamics"))
	...
	PIt("test if appdynamics was successfully bound", func() {
